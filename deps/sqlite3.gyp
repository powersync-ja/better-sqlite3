...

{
    ...
    "targets": [
                        ...
                        "actions": [
                            {
                                ...
                                "inputs": [
                                    "sqlite3/sqlite3mc_amalgamation.c",
                                    "sqlite3/sqlite3.h",
                                    "sqlite3/sqlite3ext.h",
                                ],
                                "outputs": [
                                    "<(SHARED_INTERMEDIATE_DIR)/sqlite3/sqlite3mc_amalgamation.c",
        ...
        },
        {
            ...
            "sources": ["<(SHARED_INTERMEDIATE_DIR)/sqlite3/sqlite3mc_amalgamation.c"],
            ...
            "configurations": {
                "Debug": {
                    "msvs_settings": {
                        "VCCLCompilerTool": {"RuntimeLibrary": 1}
                    },  # static debug
                },
                "Release": {
                    "msvs_settings": {
